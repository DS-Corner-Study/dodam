...
/**
 * JWT 토큰을 생성하고 유효성을 검증하는 컴포넌트 클래스 JWT 는 여러 암호화 알고리즘을 제공하고 알고리즘과 비밀키를 가지고 토큰을 생성함
 * <p>
...
public class JwtTokenProvider {
    ...
    public String resolveToken(HttpServletRequest request) {
        ...
        return request.getHeader("X-AUTH-TOKEN"); // 헤더 값으로 전달된 'X-AUTH-TOKEN' 값을 가져와 리턴
    }
